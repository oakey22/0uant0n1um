...
#ifndef _QuantoniumRPC_H_
#define _QuantoniumRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Quantonium is not connected
...
/**
 * Quantonium RPC command dispatcher.
 */
class CRPCTable
{
private:
