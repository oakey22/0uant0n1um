...
#ifndef H_Quantonium_SCRIPT
#define H_Quantonium_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CQuantoniumAddress
 */
...
public:
    ...
    // Pre-version-0.6, Quantonium always counted CHECKMULTISIGs
